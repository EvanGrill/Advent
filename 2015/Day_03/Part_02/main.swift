...
func calculateDrops( input: String ) -> Int {
	...
	var RobocoordNS = 0
	var RobocoordEW = 0
	var loc = Pair( x: SantacoordEW, y: SantacoordNS )
	...
	for move in input {
		if points % 2 == 0 {
			switch move {
				case "<":
					SantacoordEW = SantacoordEW - 1
				case ">":
					SantacoordEW = SantacoordEW + 1
				case "v":
					SantacoordNS = SantacoordNS - 1
				case "^":
					SantacoordNS = SantacoordNS + 1
				default:
					print( "fell through" )
			}
			loc = Pair( x: SantacoordEW, y: SantacoordNS )
			...
			switch move {
				case "<":
					RobocoordEW = RobocoordEW - 1
				case ">":
					RobocoordEW = RobocoordEW + 1
				case "v":
					RobocoordNS = RobocoordNS - 1
				case "^":
					RobocoordNS = RobocoordNS + 1
				default:
					print( "fell through" )
			}
			loc = Pair( x: RobocoordEW, y: RobocoordNS )
			if( !locations.contains( loc ) ) {
				locations.insert( loc )
			}
		}
