...
func turnOn( grid: inout [[Int]], topLeft: Pair, bottomRight: Pair ) {
...
func turnOff( grid: inout [[Int]], topLeft: Pair, bottomRight: Pair ) {
	for i in topLeft.x ... bottomRight.x {
		for j in topLeft.y ... bottomRight.y {
			grid[i][j] = grid[i][j] - 1
			if( grid[i][j] < 0 ) {
...
func toggle( grid: inout [[Int]], topLeft: Pair, bottomRight: Pair ) {
	for i in topLeft.x ... bottomRight.x {
		for j in topLeft.y ... bottomRight.y {
			grid[i][j] = grid[i][j] + 2
		}
...
func parseInstruction( grid: inout [[Int]], input: String ) {
